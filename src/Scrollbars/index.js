...
export default class Scrollbars extends Component {
  ...
  hideTracks() {
    ...
    const { autoHideTimeout, autoHideOpacity } = this.props;
    clearTimeout(this.hideTracksTimeout);
    this.hideTracksTimeout = setTimeout(() => {
      css(this.trackHorizontal, { opacity: autoHideOpacity });
      css(this.trackVertical, { opacity: autoHideOpacity });
    }, autoHideTimeout);
  }
...
Scrollbars.propTypes = {
  ...
  autoHideOpacity: PropTypes.number,
